...
/* harmony import */ var src_app_post_modal_post_modal_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/post-modal/post-modal.component */ "./src/app/post-modal/post-modal.component.ts");
...
let HomePage = class HomePage {
    constructor(photoService, http, modalCtrl) {
    ...
    getGallery() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.http.get('http://localhost:8000/api/gallery/').subscribe((resp) => {
    ...
    getNextPage() {
        if (this.nextUrl !== null) {
            this.http.get(this.nextUrl).subscribe((resp) => {
...
], PostModalComponent.prototype, "img", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], PostModalComponent.prototype, "date", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], PostModalComponent.prototype, "caption", void 0);
PostModalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-post-modal',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./post-modal.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/post-modal/post-modal.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./post-modal.component.scss */ "./src/app/post-modal/post-modal.component.scss")).default]
    })
], PostModalComponent);
...
const { Camera, Filesystem, Storage } = _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"];
...
let PhotoService = class PhotoService {
    ...
    addPhotoToList(imagePath, caption, date) {
    ...
    pushPhotoToList(imagePath, caption, date) {
        this.photos.unshift({
            filepath: imagePath,
            caption: caption,
            date: date,
    ...
    takePhoto() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const caption = yield this.presentPrompt().then(data => { return data; });
            this.sendPost(capturedPhoto.webPath, caption);
        });
    }
    sendPost(webPath, caption) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const blob = yield fetch(webPath).then((resp) => resp.blob());
            const formData = new FormData();
            formData.append('image', blob);
            formData.append('caption', caption);
            this.http.post('http://localhost:8000/api/gallery/new', formData).subscribe((resp) => {
    ...
    presentPrompt() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            let cap;
            yield alert.present();
            yield alert.onDidDismiss().then((data) => { cap = data.data.values.caption; });
            return cap;
        });
    }
};
